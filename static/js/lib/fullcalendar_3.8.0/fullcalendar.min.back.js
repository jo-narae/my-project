...
!function (t, e) {
  ...
  return function (t) {
    ...
    var o = n(0), s = n(3), a = n(4), l = /^\s*\d{4}-\d\d$/,
      u = /^\s*\d{4}-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?)?$/, d = o.fn;
    e.newMomentProto = d;
    var c = s.extend({}, d);
    e.oldMomentProto = c;
    ...
    var i = n(5), r = function () {
      ...
      return t.parse = function (e, n) {
        ...
        if (!i) return !1;
        var o = n.calendar, s = o.moment(i), a = r ? o.moment(r) : null, l = e.allDay, u = o.opt("forceEventDuration");
    ...
    function s(t, e, n, i, r) {
      var o, s, a, l = t.sameUnits, u = e.clone().stripZone(), d = n.clone().stripZone(), c = f(t.fakeFormatString, e),
        p = f(t.fakeFormatString, n), h = "", v = "", y = "", m = "", w = "";
    ...
    var i = n(2), r = n(4), o = n(14), s = function (t) {
      ...
      return i.__extends(e, t), e.prototype.updateDayTable = function () {
        ...
        var e, n, i, r, o, s = this.daysPerRow, a = this.view.computeDayRange(t), l = this.getDateDayIndex(a.start),
        ...
        var e, n, i, r, o, s, a = this.daysPerRow, l = this.view.computeDayRange(t), u = this.getDateDayIndex(l.start),
    ...
    Object.defineProperty(e, "__esModule", {value: !0});
    var i = n(2), r = n(14), o = n(241), s = n(221), a = n(59), l = n(220), u = n(219), d = n(218), c = function (t) {
      function e() {
        return null !== t && t.apply(this, arguments) || this
      }
    ...
    var i = n(2), r = n(3), o = n(4), s = n(53), a = n(245), l = n(5), u = n(12), d = n(35), c = n(56), p = n(60),
      h = n(40), f = n(55), g = n(246), v = n(247), y = n(248), m = function (t) {
        ...
        return i.__extends(e, t), e.prototype.componentFootprintToSegs = function (t) {
          ...
          var n, i, o, s, a, l, u, d, c, p, h, f, g, v, y, m = this, w = this.eventRenderer.rowStructs[t], b = [], D = 0,
            E = function (n) {
          ...
          return r('<a class="fc-more"/>').text(this.getMoreLinkText(n.length)).on("click", function (s) {
            var a = i.opt("eventLimitClick"), l = i.getCellDate(t, e), u = r(s.currentTarget), d = i.getCellEl(t, e),
              c = i.getCellSegs(t, e), p = i.resliceDaySegs(c, l), h = i.resliceDaySegs(n, l);
          ...
          var i, s = this.view, a = s.calendar.theme, l = this.getCellDate(t, e).format(this.opt("dayPopoverFormat")),
    ...
    var r = n(2), o = n(3), s = n(0), a = n(4), l = n(10), u = n(47), d = n(233), c = n(34), p = function (t) {
      ...
      return r.__extends(e, t), e.prototype.addChild = function (t) {
        ...
        var e = this._getCalendar(), n = e.msToUtcMoment(t.startMs, !0), i = e.msToUtcMoment(t.endMs), r = +i.time(),
          o = i.clone().stripTime();
    ...
    var r = n(3), o = n(0), s = n(4), a = n(31), l = n(234), u = n(20), d = n(11), c = n(7), p = n(235), h = n(236),
      f = n(237), g = n(203), v = n(30), y = n(10), m = n(5), w = n(12), b = n(17), D = n(238), E = n(208), S = n(37),
      C = n(49), R = n(13), T = n(36), M = n(6), I = n(51), H = function () {
        function t(t, e) {
      ...
      y = [{hours: 1}, {minutes: 30}, {minutes: 15}, {seconds: 30}, {seconds: 15}], m = function (t) {
        ...
        return i.__extends(e, t), e.prototype.componentFootprintToSegs = function (t) {
          ...
          if (i.isLeftInBounds(t) && r.isTopInBounds(e)) {
            ...
            if (null != o && null != s) {
              var a = r.getTopOffset(s), l = r.getHeight(s), u = (e - a) / l, d = Math.floor(u * n), c = s * n + d,
                p = a + d / n * l, h = a + (d + 1) / n * l;
              return {
                col: o,
                snap: c,
                component: this,
    ...
    var i = n(3), r = n(4), o = function () {
      ...
      return t.prototype.setToolbarOptions = function (t) {
        ...
        var e = this, n = this.calendar, o = n.theme, s = n.optionsManager, a = n.viewSpecManager,
          l = i('<div class="fc-' + t + '"/>'), u = this.toolbarOptions.layout[t], d = s.get("customButtons") || {},
          c = s.overrides.buttonText || {}, p = s.get("buttonText") || {};
    ...
    var i = n(2), r = n(4), o = n(42), s = function (t) {
      ...
      return i.__extends(e, t), e.prototype.renderFgSegs = function (t) {
        ...
        var e, n = this.view, i = n.calendar, o = i.theme, s = t.footprint, a = s.eventDef, l = s.componentFootprint,
          u = a.url, d = ["fc-list-item"].concat(this.getClasses(a)), c = this.getBgColor(a);
    ...
    }), i.defineView("agendaDay", {type: "agenda", duration: {days: 1}}), i.defineView("agendaWeek", {
      type: "agenda",
      duration: {weeks: 1}
    })
  }, function (t, e, n) {
